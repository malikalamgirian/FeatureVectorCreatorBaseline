...
//                OverlapCoefficient_Without_POS_String = OverlapCoefficient_Without_POS_NodeList.item(i).getTextContent();
                ...
                if (i == 0) {
                     ...
                     *
                     * 
                     * String1Id,String2Id,LcsOfLexemesBasedCosineSimilarity,LcsOfLexemesBasedOverlapCoefficient,LcsOfLexemesBasedEventDetection,Polarity,VerbOrAdjectiveAntonymMatch,pair_Quality";
                     * 
                     */
